...
ipcMain.on("join_war_request", async (_, data) => {
  const result = await client.sendPacketAsync(ClassKeys.join_war_request, data);
...
async function subscribeClient() {
  ...
  await client.sendPacketAsync(ClassKeys.subscribecommandnodeview);
}

async function unsubscribeClient() {
  await client.sendPacketAsync(ClassKeys.unsubscribewarmapview);
  await client.sendPacketAsync(ClassKeys.unsubscribecommandnodeview);
}
